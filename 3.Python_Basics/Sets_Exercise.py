...
# Using what you learned about sets, create a piece of code that the school principal can use
# to immediately find out who missed class, so they can call the parents.
